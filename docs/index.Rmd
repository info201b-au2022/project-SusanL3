...
1. **U.S. Greenhouse Gas Emissions by Gas Sector, 1990–2020 (Environmental Protection Agency, 2022)**
    ...
    **Aggregate Table**:
    ...
    > The table includes four types of carbon emissions and the total amount it omitted. Calculating the total amount lets us recognize which greenhouse gasses omit the most to find solutions to reduce them. Additionally, showing the total amount instead of each year's emissions can have a simple graph for readers to observe.
...
```
    ...
    **Aggregate Table**:
    ...
    > The table has indexes from the years 1910 to 2021. It shows the average extremes from the dates to examine the changes over time. Additionally, we calculated this table to find out what was happening over time with climate change and to find answers to our research question.
